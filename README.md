...
- test/load.js — test ladowania: wykonuje caly JS na atrapach DOM i wykrywa bledy przy starcie
...
Po zmianach w js/ warto podbic wersje cache (i od razu uruchomic testy):
