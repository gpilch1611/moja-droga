...
function openSettingsBase(){
  ...
  if(!ST.seenWiggle){ST.seenWiggle=true;save();['iSettingsBtn','eSettingsBtn','wSettingsBtn'].forEach(function(id){var b=document.getElementById(id);if(b)b.classList.remove('wig');});}
...
document.getElementById('wSettingsBtn')&&document.getElementById('wSettingsBtn').addEventListener('click',openSettingsBase);
